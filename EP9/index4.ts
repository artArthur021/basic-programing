const football = {
    ...
    downScore40: function () {
        return this.league.standings.filter(function (element, index) {
            return element.points < 40
        }).length
    },
    nagativeScore: function () {
        return this.league.standings.filter(function (element, index) {
            return element.all.goals.against < 0
        })
    },
     loseiInhome: function () {
        return this.league.standings.filter(function (element, index) {
...
console.log(football.downrank())
console.log(football.myteam())
console.log(football.goalsdiff())
console.log(football.downScore40())
console.log(football.nagativeScore())
console.log(football.loseiInhome())
console.log(football.loseAway())
